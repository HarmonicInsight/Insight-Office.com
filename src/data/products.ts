...
export const products: Product[] = [
  // === Strategy & Proposal Toolkit ===
  {
    ...
    description: {
      en: "Elevate the quality of your proposal decks and deliverable presentations with AI-powered review. Detect inconsistencies, check logical flow, validate data references, and enforce brand compliance — so every slide that reaches your client meets the highest standard.",
      ja: "AIレビューで提案書や納品プレゼンの品質を向上。矛盾の検出、論理フローのチェック、データ参照の検証、ブランドコンプライアンスの適用 — クライアントに届くすべてのスライドが最高品質であることを保証します。",
      zh: "通过AI审核提升提案资料和交付演示的质量。检测不一致性、检查逻辑流程、验证数据引用、确保品牌合规 — 确保每张幻灯片都达到最高标准。",
    },
    features: {
      en: [
        "AI presentation review and feedback",
        "Logical flow and consistency checking",
        "Data reference validation",
        "Brand compliance enforcement",
        "Cross-slide contradiction detection",
        "Team review workflow support",
      ],
      ja: [
        "AIプレゼンテーションレビューとフィードバック",
        "論理フロー・整合性チェック",
        "データ参照の検証",
        "ブランドコンプライアンスの適用",
        "スライド間の矛盾検出",
    ...
    useCases: {
      en: [
        "Proposal deck quality review before client submission",
        "Deliverable consistency check across project team members",
        "Executive presentation logic and data validation",
        "Brand and formatting compliance enforcement",
      ],
      ja: [
        "クライアント提出前の提案書品質レビュー",
        "プロジェクトチーム間の納品物整合性チェック",
        "エグゼクティブ向けプレゼンのロジック・データ検証",
        "ブランド・フォーマットのコンプライアンス適用",
      ],
      zh: [
        "提交客户前的提案资料质量审核",
        "项目团队间交付物一致性检查",
  ...
  },
  {
    ...
    description: {
      en: "Improve the quality of requirements documents, RFP responses, and consulting deliverables through AI-powered review and checking. Detect ambiguities in requirements, validate cross-references, check terminology consistency, and ensure deliverables meet client standards before submission.",
      ja: "AIレビュー・チェックで要件定義書、RFP回答書、コンサルティング納品物の品質を向上。要件のあいまいさを検出し、相互参照を検証し、用語の一貫性をチェックし、提出前に納品物がクライアント基準を満たしていることを保証します。",
      zh: "通过AI审核与检查提升需求文档、RFP回复和咨询交付物的质量。检测需求歧义、验证交叉引用、检查术语一致性，确保交付物在提交前达到客户标准。",
    },
    features: {
      en: [
    ...
    useCases: {
      en: [
        "Requirements document quality review before client sign-off",
        "RFP response consistency and completeness checking",
        "Cross-team deliverable quality assurance",
        "Contract and SLA clause validation",
      ],
      ja: [
        "クライアント承認前の要件定義書品質レビュー",
        "RFP回答書の整合性・網羅性チェック",
        "チーム横断の納品物品質保証",
        "契約書・SLA条項の検証",
      ],
