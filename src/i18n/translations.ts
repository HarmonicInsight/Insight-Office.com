...
export const translations: Record<Locale, TranslationSet> = {
  ...
  ja: {
    ...
    hero: {
      title: "28年に渡る業務コンサル、システム設計・開発の実績から生まれたツール群",
      subtitle:
    ...
    products: {
      title: "ソリューションラインナップ",
      subtitle:
        "自動化・デリバリーから業務調査・要件定義・提案・経営シミュレーション、コンテンツ作成まで — コンサルティングの全フェーズをカバーする8ツール。これらのパッケージ群を元に、業務に最適なソリューションをカスタマイズ構築します。",
