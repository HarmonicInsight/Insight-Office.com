...
export const translations: Record<Locale, TranslationSet> = {
  en: {
    ...
    pricing: {
      title: "Pricing",
      subtitle: "Per-product annual license + AI ticket — buy only what you need",
      perYear: "/year",
      perProduct: "/product",
      perQuery: "/query",
      licenseSectionTitle: "Product License",
      ...
      trialPrice: "¥0",
      trialDesc: "Try any product free for 30 days",
      trialFeatures: [
        "30-day full-featured trial",
        "50 AI assistant queries included",
        "No credit card required",
      ],
      standardLabel: "1 User",
      standardPrice: "¥39,800",
      standardUnit: "/product/user/year",
      standardDesc: "Choose the product you need — one license per product",
      standardFeatures: [
      ...
      team5Label: "5 Users",
      team5Price: "¥149,000",
      team5Unit: "/product/5 users/year",
      team5Discount: "25% OFF",
      team5Desc: "¥29,800/user — ideal for small teams",
      team10Label: "10 Users",
      team10Price: "¥248,000",
      team10Unit: "/product/10 users/year",
      ...
      taxNote: "All prices exclude tax. Prices are per product. Custom pricing available for large deployments.",
  ...
  ja: {
    ...
    pricing: {
      title: "料金プラン",
      subtitle: "1製品単位の年間ライセンス + AIチケット — 必要な製品だけ購入",
      perYear: "/年",
      perProduct: "/製品",
      perQuery: "/回",
      licenseSectionTitle: "製品ライセンス",
      aiSectionTitle: "AIアシスタントチケット",
      aiSectionSubtitle: "Claude搭載 — 1回¥30〜50でAIコンサルタントに相談",
      trialLabel: "無料トライアル",
      trialPrice: "¥0",
      trialDesc: "各製品を30日間無料でお試し",
      trialFeatures: [
        "30日間の全機能トライアル",
        "AIアシスタント50回分付き",
        "クレジットカード不要",
      ...
      standardLabel: "1ユーザー",
      standardPrice: "¥39,800",
      standardUnit: "/製品/ユーザー/年",
      standardDesc: "必要な製品を選んで購入 — 1製品ごとのライセンス",
      standardFeatures: [
        "選択した製品の全機能",
        "製品アップデート込み",
        "メールサポート",
      ...
      team5Label: "5ユーザー",
      team5Price: "¥149,000",
      team5Unit: "/製品/5ユーザー/年",
      team5Discount: "25% OFF",
      team5Desc: "1ユーザーあたり¥29,800 — 少人数チームに最適",
      team10Label: "10ユーザー",
      team10Price: "¥248,000",
      team10Unit: "/製品/10ユーザー/年",
      team10Discount: "38% OFF",
      ...
      taxNote: "表示価格は税別です。価格は1製品あたりの料金です。大規模導入の場合はお見積りいたします。",
  ...
  zh: {
    ...
    pricing: {
      title: "价格方案",
      subtitle: "按产品年度许可证 + AI工单 — 只购买您需要的产品",
      perYear: "/年",
      perProduct: "/产品",
      perQuery: "/次",
      licenseSectionTitle: "产品许可证",
      aiSectionTitle: "AI助手工单",
      aiSectionSubtitle: "搭载Claude — 每次咨询仅需¥30–50即可获得AI专家建议",
      trialLabel: "免费试用",
      trialPrice: "¥0",
      trialDesc: "任意产品30天免费体验",
      trialFeatures: [
        "30天全功能试用",
        "含50次AI助手查询",
        "无需信用卡",
      ...
      standardLabel: "1用户",
      standardPrice: "¥39,800",
      standardUnit: "/产品/用户/年",
      standardDesc: "选择您需要的产品 — 按产品单独授权",
      standardFeatures: [
        "所选产品的全部功能",
        "包含产品更新",
        "邮件支持",
      ...
      contactSales: "联系销售",
      startTrial: "开始免费试用",
      taxNote: "所有价格不含税。价格为单个产品的费用。大规模部署可提供定制报价。",
